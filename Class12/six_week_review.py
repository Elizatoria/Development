...
# Create a variable for your first name and a variable for your last name. 
# Concatenate and print them in a new variable called 'fullname'.
first_name = 'Victoria'
last_name = 'Forrest'
full_name = first_name + ' ' + last_name
# print(full_name)

# Create a variable called greeting and assign it to string value of 'hip hop hooray'. 
# Using multiplication, create a third variable called 'three cheers' which repeats greeting 3 times.
...
username = '#$(@#@#$#@)'
us_check1 = username.isidentifier()
# print(us_check1)

username2 = 'simonsays_90'
us_check2 = username2.isidentifier()
# print(us_check2)

username3 = '3492_sdfsdf'
us_check3 = username3.isidentifier()
# print(us_check3)

username4 = 'hello*world'
us_check4 = username4.isidentifier()
# print(us_check4)
...
# Replace J with B
test_name = 'jerry'
new_name = test_name.replace('j', 'b')
# print(new_name)
