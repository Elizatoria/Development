...
A range is different from a list of numbers, 
in that it does not store all the numbers it instead uses calculations to determine what the numbers should be.
...
# for i in range(3, 2):  # No output
#     print(i)

# for i in range(3, 2, -1):  # Output of 3
#     print(i)
...
'''
# for y in range(1960, 2001, 5):
#     print(f'{y} is 5 years later.')
...
'''
Rewrite the for loop we made last class that goes through a list and prints each item in the list, along with its index. 
(Hint: you can use a range, and you won't need a separate counter variable.)
...
#     print(f'{employees[e]} is a {job_titles[e]}')
